...
CREATE PROCEDURE food.sp_write_log
    @actor_id INT, @operation_type VARCHAR(10), @target_table VARCHAR(50), @target_id VARCHAR(50),
...
BEGIN
    ...
    VALUES (@actor_id, @operation_type, 'food', @target_table, @target_id, @old_value, @new_value, SYSDATETIME(), @description, @branch_id);
END
