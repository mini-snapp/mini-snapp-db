...
CREATE TABLE core.permissions(
    ...
    permissions_description VARCHAR(150),

    CONSTRAINT pk_permissions 
        PRIMARY KEY (permission_id),

    CONSTRAINT uq_premissions_permission_name 
        UNIQUE (permissions_name)
...
CREATE TABLE core.user_favorite_foods (
        
        ufd_id INT IDENTITY(1,1) NOT NULL,
        user_id INT NOT NULL,
        food_id INT NOT NULL,
 
        CONSTRAINT pk_user_favorite_foods 
            PRIMARY KEY (ufd_id),

        CONSTRAINT uq_user_favorite_foods_user_food 
            UNIQUE (user_id, food_id),
        
        CONSTRAINT fk_user_favorite_foods_user_id 
            FOREIGN KEY (user_id) REFERENCES core.users(user_id)
